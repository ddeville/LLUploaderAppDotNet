...
/*!
	...
	NB: if you return an <tt>NSError</tt> with an <tt>NSRecoveryAttempterKey</tt>, you MUST return NO from recovery. Returning YES is reserved for future use.
 ...
 */
@property (readonly, retain, nonatomic) RMUploadPreset *destination;
 ...
 */
@property (readonly, retain, nonatomic) id uploadInfo;

/*!
	\brief
	The central method to the class. Ensure that you are posting the correct notifications. 
...
/*!
	...
	\details
	In RMUploadKit version 1.0, this can be received from any thread.
	In RMUploadKit version 1.1 and later, this is always received on the same thread <tt>-upload</tt> was sent on.
*/
- (void)cancel;
 ...
 */
@property (readonly, getter=isCancelled, RMUPLOAD_PROPERTY_ATOMIC) BOOL cancelled;
